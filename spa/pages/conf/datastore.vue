  ...
  data() {
    return {
      ...
      cleanupTargetList: [
        ...
        { text: 'イベントログ', value: 'log/logs' },
        { text: 'Syslog', value: 'log/syslog' },
        { text: 'SNMP Trap', value: 'log/trap' },
        { text: 'NetFlow', value: 'log/netflow' },
        { text: 'IPFIX', value: 'log/ipfix' },
        { text: 'sFlow', value: 'log/sflow' },
        { text: 'sFlowカウンター', value: 'log/sflowCounter' },
